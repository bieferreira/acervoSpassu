...
try {
    ...
    $sql = "SELECT * FROM ".MIGRATION."Autor WHERE Excluido = :excluido ORDER BY Nome LIMIT :limit OFFSET :offset";
    ...
    $totalSql = "SELECT COUNT(*) as total FROM ".MIGRATION."Autor WHERE Excluido = :excluido";
