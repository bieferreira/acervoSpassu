    ...
    <form action="" onsubmit="return false;" name="form_create" METHOD="post" class="ui form">
        ...
        <div id='tab_new_conn'>
            <div id='tabs_selector' class="ui top attached tabular menu">
                ...
                <?php
                if ($dbms == 'mysql' || $dbms == 'mariadb' || $dbms == 'postgres' || $dbms == 'mssql') {
                    ?>
                ...
                <?php
                    if($obj_conn->nm_db_sc_type($dbms) == 'mysql' || $obj_conn->nm_db_sc_type($dbms) == 'mariadb')
                    {
                        ...
                        <div class="field" id='tr_use_ssl'>
                            ...
                            <div class="ui">
                                <input type="radio" name='use_ssl' id='use_ssl_y' value="Y" onClick="$('#carregar_db').val('S');" <?php echo ($use_ssl=='Y')?"checked=checked":""; ?> />
                                <label for="use_ssl_y"><?php echo $nm_lang['values']['sim']; ?></label>
                                &nbsp;&nbsp;
                                <input type="radio" name='use_ssl' id='use_ssl_n' value="N" onClick="$('#carregar_db').val('N');" <?php echo ($use_ssl!='Y')?"checked=checked":""; ?> />
