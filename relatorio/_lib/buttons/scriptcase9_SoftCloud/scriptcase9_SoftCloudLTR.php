<?php
  ...
  $this->arr_buttons['bcons_inicio']['style'] = 'icons';
  ...
  $this->arr_buttons['bcons_retorna']['fontawesomeicon']  = 'fas fa-chevron-left';
  $this->arr_buttons['bcons_retorna']['style'] = 'icons';
  ...
  $this->arr_buttons['bcons_avanca']['fontawesomeicon']  = 'fas fa-chevron-right';
  $this->arr_buttons['bcons_avanca']['style'] = 'icons';
  ...
  $this->arr_buttons['bcons_final']['style'] = 'icons';
  ...
  $this->arr_buttons['bcons_apply']['style'] = 'primary_sm';
  ...
  $this->arr_buttons['bcons_cancel']['style'] = 'danger_sm';
  ...
  $this->arr_buttons['bmultiselect']['style'] = 'default_sm';
  ...
  $this->arr_buttons['binicio']['style'] = 'icons';
  ...
  $this->arr_buttons['bretorna']['fontawesomeicon']  = 'fas fa-chevron-left';
  $this->arr_buttons['bretorna']['style'] = 'icons';
  ...
  $this->arr_buttons['bavanca']['fontawesomeicon']  = 'fas fa-chevron-right';
  $this->arr_buttons['bavanca']['style'] = 'icons';
  ...
  $this->arr_buttons['bfinal']['style'] = 'icons';
  ...
  $this->arr_buttons['bincluir']['style'] = 'success';
  ...
  $this->arr_buttons['bnovo']['style'] = 'success';
  ...
  $this->arr_buttons['bok']['style'] = 'primary';
  ...
  $this->arr_buttons['bsrch_mtmf']['style'] = 'primary';
  ...
  $this->arr_buttons['bcresumo']['style'] = 'primary';
  ...
  $this->arr_buttons['bpesquisa']['style'] = 'primary';
  ...
  $this->arr_buttons['bsalvar']['style'] = 'default_sm';
  ...
  $this->arr_buttons['blimparsummaryall']['style'] = 'danger_sm';
  ...
  $this->arr_buttons['boksummary']['style'] = 'primary';
  ...
  $this->arr_buttons['bfilref_apply']['style'] = 'primary_sm';
  ...
  $this->arr_buttons['bfacebook']['style'] = 'ot_facebook';
  ...
  $this->arr_buttons['bgoogle']['style'] = 'ot_google';
  ...
  $this->arr_buttons['bpaypal']['style'] = 'ot_paypal';
  ...
  $this->arr_buttons['btwitter']['style'] = 'ot_twitter';
  ...
  $this->arr_buttons['bapply']['style'] = 'primary';
  ...
  $this->arr_buttons['bmessageclose']['style'] = 'danger_sm';
  ...
  $this->arr_buttons['byoutube']['style'] = 'ot_youtube';
  ...
  $this->arr_buttons['breload']['style'] = 'icons';
  ...
  $this->arr_buttons['bapply_appdiv']['style'] = 'primary_sm';
  ...
  $this->arr_buttons['bok_appdiv']['style'] = 'primary_sm';
  ...
  $this->arr_buttons['brestore_appdiv']['style'] = 'default_sm';
  ...
  $this->arr_buttons['blimpar_appdiv']['style'] = 'default_sm';
  ...
  $this->arr_buttons['bsair_appdiv']['style'] = 'danger_sm';
  ...
  $this->arr_buttons['bcancelar_appdiv']['style'] = 'danger_sm';
  ...
  $this->arr_buttons['bsalvar_appdiv']['style'] = 'default_sm';
  ...
  $this->arr_buttons['bexcluir_appdiv']['style'] = 'default_sm';
  ...
  $this->arr_buttons['bedit_filter_appdiv']['style'] = 'default_sm';
  ...
  $this->arr_buttons['bnovo_appdiv']['style'] = 'primary_sm';
  ...
  $this->arr_buttons['bzipcode']['image'] = 'scriptcase__NM__nm_scriptcase9_SoftCloud_place.png';
