<?php
@session_start() ;
$_SESSION['scriptcase']['autor_livros_assuntos']['sc_process_barr'] = true;
require_once('../autor_livros_assuntos/index.php');
unset($_SESSION['scriptcase']['autor_livros_assuntos']['sc_process_barr']);
$ExportCtrl = new autor_livros_assuntos_export_control;
$ExportCtrl->Export_barr();

class autor_livros_assuntos_export_control
{
