...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["acervoSpassu_____autor_livros_assuntos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["acervoSpassu_____autor_livros_assuntos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['autor_livros_assuntos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['autor_livros_assuntos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['autor_livros_assuntos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['autor_livros_assuntos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['autor_livros_assuntos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>autor_livros_assuntos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['autor_livros_assuntos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['autor_livros_assuntos']['embutida_filho'] as $ind => $sc_init)
          {
