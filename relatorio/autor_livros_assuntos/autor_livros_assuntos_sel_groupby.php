<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['autor_livros_assuntos']['glo_nm_path_imag_temp'] . "/sc_apl_default_acervoSpassu.txt"))
       {
?>
...
<?php
   ...
   $Sel_Groupby = new autor_livros_assuntos_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class autor_livros_assuntos_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   if ($this->restore) {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['all']['SC_Ind_Groupby'];
   }
   else {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Ind_Groupby'];
   }
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       if (isset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['using_summary_cache'])) {
           unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['using_summary_cache']);
       }
       $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_order_start']);
       unset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_tabular']);
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['nomeautor'] = array('cmp' => "NomeAutor", 'ind' => 0, 'format' => "");
           $tab_arr_groubby_sql[0] = array('cmp' => "NomeAutor", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       if (array_key_exists('pivot_x_axys', $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos'])) {
           if ($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_x_axys'] != $xaxys_list || $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_y_axys'] != $yaxys_list) {
               $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['contr_array_resumo'] = "NAO";
               $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['contr_total_geral']  = "NAO";
           }
       }
       $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo")
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['nomeautor'] = "Autor";
...
<HEAD>
 <TITLE>Relatório Autor, Livro e Assunto</TITLE>
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "autor_livros_assuntos_sel_groupby.php",
    data: {
...
<?php
if ($this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['res']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['res']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
elseif (!$this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
        if(is_array($_arr_fields))
        {
            foreach ($_arr_fields as $_key_total => $d_field)
...
{
  $max_height = 1;
  if ($this->restore && isset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['res']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['res']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
  ...
  elseif (!$this->restore && isset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
      if (count($_i_sum) > $max_height)
      {
          $max_height = count($_i_sum);
...
<?php
if ($bSummaryPage && $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Ind_Groupby'] == "sc_free_group_by") {
?>
   if (fieldList == "") {
...
<style>
#id_totalization_fields_firstname_title {
    padding: 0 5px !important;
}
    #sc_id_summary_fields {
        height: 150px;
    }
    #sc_id_static_groupby .GroupByOptions {
        height: 222px !important;
    }
    #sc_id_free_groupby {
        height: 264px;
    }
    #sc_id_free_groupby .sc_ui_sortable-wrapper {
        display: flex;
        flex-direction: row;
        align-items: center;
    ...
    #sc_id_free_groupby .sc_ui_sorting-buttons-wrapper {
        min-width: 10px;
        display: flex;
    ...
    #sc_id_free_groupby .sc_ui_sorting-buttons-wrapper > a {
        max-width: 35px;
        min-width: 35px;
        box-sizing: border-box;
        padding-left: 0;
    ...
    #sc_id_free_groupby .sc_ui_sorting-list-wrapper {
        flex-grow: 1;
        display: flex;
        flex-direction: column;
        align-items: stretch;
    ...
    #sc_id_free_groupby .sc_ui_sorting-list {
        flex-grow: 1;
        flex-basis: 0px;
        margin: 0;
        list-style: none;
    ...
    #sc_id_free_groupby .sc_ui_sorting-list-wrapper h4 {
        text-align: center;
        margin: 10px 0 5px 0;
    }

    #sc_id_free_groupby .sc_ui_sorting-list li {
        display: flex;
        flex-direction: row;
        align-items: center;
        justify-content: flex-start;
    ...
    #sc_id_free_groupby .sc_ui_sorting-list li.hidden-opt {
        display: none;
    }
    #sc_id_free_groupby .sc_ui_sorting-list li:hover {
    }
    #sc_id_free_groupby .sc_ui_sortable-item-moving {
        opacity: .3;
    }
    #sc_id_free_groupby .sc_ui_sorting-list-item-selected {
        background: Highlight;
        color: HighlightText;
    }
    #sc_id_free_groupby .sc_ui_sorting-search-container {
        padding: 0 5px;
        display: flex;
        flex-direction: column;
        align-items: stretch;
    ...
    #sc_id_free_groupby .sc_ui_sorting-list-item-handle {
        position: absolute;
        right: 5px;
        top: 50%;
        transform: translateY(-50%);
    }
    #sc_id_free_groupby .scAppDivSelectFieldsDisabled .sc_ui_sorting-list-item-handle {
        display: none;
    }
    #sc_id_free_groupby .scAppDivSelectFieldsDisabled {
        cursor: default !important;
    }
    #sc_id_free_groupby .sc_ui_right-sortable-list .sc_ui_sorting-list-item select {
        display: inline-block !important;
    }

    #sc_id_free_groupby .sc_ui_left-sortable-list .sc_ui_sorting-list-item select {
    ...
    #sc_id_free_groupby .sc_ui_sorting-list-item-block {
        display: flex;
        flex-direction: column;
        justify-content: center;
    ...
    #sc_id_free_groupby .sc_ui_sorting-list-item-block select {
        padding: 0;
        height: auto;
    }
...
.GroupByOptions > div > input:checked + label {
    background: rgb(0 145 190 / 15%);
    border: solid 1px rgb(0 95 171 / 22%);
}

.GroupByOptions > div > label:before {
    content: '\2714';
    display: none;
    position: absolute;
    left: 14px;
...
.GroupByOptions > div > input:checked + label:before {
    display: block;
}
</style>
<script language="javascript" type="text/javascript" src="../_lib/lib/js/sortable.js?v=9.07.0001"></script>
<script language="javascript" type="text/javascript" src="../_lib/lib/js/sortable.jquery.js?v=9.07.0001"></script> <tr>
  <td width='100%' id="sc_id_free_groupby">
<?php
    if ($this->restore) {
        ob_end_clean();
        ob_start();
...
<?php
        ...
        {
?>
      <p><?php echo $this->Nm_lang['lang_othr_groupby_required']; ?></p>
<?php
        }
?>
 <div  class="sc_ui_sortable-wrapper">
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Groupby_hide']))
     {
...
<?php
        ...
        $arr_tmp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] : $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Gb_Free_cmp'];
...
?>
       <h4><?php echo $this->Nm_lang['lang_othr_groupby_available_fld']; ?></h4>
         <ul class="sc_ui_sorting-list sc_ui_sorting-list-left scAppDivSelectFields" id="sc_id_available">
<?php
        foreach ($arr_campos_free as $NM_cada_field => $NM_cada_label)
        {
           ...
           {
?>
          <li class="sc_ui_sorting-list-item sc_ui_litem scAppDivSelectFieldsEnabled" data-id="sc_id_item_<?php echo NM_encode_input($NM_cada_field); ?>" id="sc_id_item_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $NM_cada_label; ?></li>
<?php
           }
        }
?>
...
?>
      ...
      <div class="sc_ui_sorting-list-wrapper sc_ui_right-sortable-list">
        <h4><?php echo $sYAxysLabel; ?></h4>
        <?php
?>         <ul class="sc_ui_sorting-list sc_ui_sorting-list-right scAppDivSelectFields" id="sc_id_yaxys">
<?php
        if ($bSummaryPage)
        {
            if ($this->restore) {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['res']['pivot_x_axys']);
            }
            else {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_x_axys']);
            }
        }
...
?>
          <li class="sc_ui_sorting-list-item sc_ui_litem scAppDivSelectFieldsEnabled" data-id="sc_id_item_<?php echo NM_encode_input($NM_cada_field); ?>" id="sc_id_item_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $arr_campos_free[$NM_cada_field]; ?></li>
<?php
        }
?>
         </ul>
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                $arr_pivot_x_axys = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['res']['pivot_x_axys'] : $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['pivot_x_axys'];
...
?>
        <div class="sc_ui_sorting-list-wrapper sc_ui_right-sortable-list">
         <h4><?php echo $this->Nm_lang['lang_othr_groupby_axis_x']; ?></h4>
         <ul class="sc_ui_sorting-list sc_ui_sorting-list-right scAppDivSelectFields" id="sc_id_xaxys">
<?php
...
<script>
    ...
    function scuiSortingmoveItems(direction, moveall) {
        var field_wrapper = $('#sc_id_free_groupby');
        var lists = {
    ...
    function outClickGrp(e) {
        var tagname = e.target.tagName;
        if (
            !$(e.target).is('a, a *, button, button *, select, select *, option, option *, input, input *, .sc_ui_sorting-list, .sc_ui_sorting-list *')
            ) {
            deselectAllGrp();
            $(document).off('mousedown.deselect_group_by');
            $(document).off('touchstart.deselect_group_by');
        }
    }
    function deselectAllGrp() {
    ...
    function sortInit() {
        $('#sc_id_free_groupby .sc_ui_sorting-search-field').on('input', function(ev) {
            var side = $(ev.target).attr('data-side');
            var list = $('#sc_id_free_groupby .sc_ui_sorting-list-'+side+' li');
          ...
          <?php
            ...
            if ($_SESSION['scriptcase']['proc_mobile']) {
                ?>
                    $('#sc_id_free_groupby .sc_ui_sorting-list-item').not('.scAppDivSelectFieldsDisabled').on('click', function(ev) {
                        ...
                        $(document).off('touchstart.deselect_group_by');
                        $(document).on('touchstart.deselect_group_by', function(e) {
                            outClickGrp(e);
                        });
                    });
                <?php
          ...
          ?>
        sc_ui_sortable_obj_sel = $('#sc_id_free_groupby .sc_ui_sorting-list-left').sortable({
            multiGrab: true,
            multiDrag: true,
            sort: false,
            ...
            onSelect: function(ev) {
                ...
                if ($('#sc_id_free_groupby').find('.sc_ui_sorting-list-item-selected')[0]) {
                    $(document).on('mousedown.deselect_group_by', function(e) {
                        if (e.button === 0) {
                            outClickGrp(e);
                        }
                    });
        ...
        sc_ui_sortable_obj_sel = $('#sc_id_free_groupby .sc_ui_sorting-list-right').sortable({
            multiGrab: true,
            multiDrag: true,
            avoidImplicitDeselect: true,
            filter: '.scAppDivSelectFieldsDisabled',
...
<?php
   ...
   if ($bSummaryPage)
   {
       ...
       if (!isset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_control'])) {
           $arr_filds = array();
       }
       else {
           $arr_filds = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['res']['summarizing_fields_control'] : $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_control'];
       }
    if (isset($arr_filds))
    {
?>
...
<style>
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sortable-wrapper {
        display: flex;
        flex-direction: row;
        align-items: stretch;
        justify-content: space-between;
    ...
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-buttons-wrapper {
        min-width: 10px;
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-buttons-wrapper > a {
        max-width: 35px;
        min-width: 35px;
        box-sizing: border-box;
        padding-left: 0;
    ...
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list-wrapper {
        flex-grow: 1;
        display: flex;
        flex-direction: column;
        align-items: stretch;
    ...
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list {
        flex-grow: 1;
        flex-basis: 0px;
        margin: 0;
        list-style: none;
    ...
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list-wrapper h4 {
        text-align: center;
        margin: 10px 0 5px 0;
    }

    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list li {
        display: flex;
        flex-direction: row;
        align-items: center;
        justify-content: flex-start;
    ...
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list li.hidden-opt {
        display: none;
    }
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list li:hover {
    }
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sortable-item-moving {
        opacity: .3;
    }
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list-item-selected {
        background: Highlight;
        color: HighlightText;
    }
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-search-container {
        padding: 0 5px;
        display: flex;
        flex-direction: column;
        align-items: stretch;
    ...
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list-item-handle {
        position: absolute;
        right: 5px;
        top: 50%;
        transform: translateY(-50%);
    }
    #id_totalization_fields_<?php echo $nome_quebra; ?> .scAppDivSelectFieldsDisabled .sc_ui_sorting-list-item-handle {
        display: none;
    }
    #id_totalization_fields_<?php echo $nome_quebra; ?> .scAppDivSelectFieldsDisabled {
        cursor: default !important;
        display: none !important;
    }
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_right-sortable-list .sc_ui_sorting-list-item select {
        display: inline-block !important;
    }

    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_left-sortable-list .sc_ui_sorting-list-item select {
        display: none !important;
    }
    <?php
    ...
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list-item-block {
        display: flex;
        flex-direction: column;
        justify-content: center;
        align-items: flex-start;
    ...
    #id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list-item-block select {
        padding: 0;
        height: auto;
    }

    #id_totalization_fields_<?php echo $nome_quebra; ?> {
        padding: 0 1rem;
    }
</style> <div  class="sc_ui_sortable-wrapper">
 <div  class="sc_ui_sorting-list-wrapper">
         <h4><?php echo $this->Nm_lang['lang_othr_groupby_totals_fld']; ?></h4>
         <ul class="sc_ui_sorting-list sc_ui_sorting-list-left sc_ui_sort_summ sc_ui_sort_summ_available sc_ui_sortable sc_ui_ulist sc_ui_ulist_total scAppDivSelectFields" id="sc_id_summ_available_<?php echo $nome_quebra; ?>">
<?php
...
?>
              <li class="sc_ui_sorting-list-item sc_ui_litem sc_ui_litem_total scAppDivSelectFieldsEnabled" id="sc_id_item_summ_<?php echo $nome_quebra; ?>_<?php echo $key_total; ?>" data-id="sc_id_item_summ_<?php echo $nome_quebra; ?>_<?php echo $key_total; ?>"><?php echo NM_encode_input($sLabel); ?><?php
                foreach ($d_field['options'] as $d_sum)
                {
                    $aSummStatus[$l_field][] = $d_sum['op'];
?>
&nbsp;<span style="position: relative; margin-left: 0<?php echo $sOpDisplay; ?>" data-sum="<?php echo $d_sum['index']; ?>" class="scAppDivSelectBoxEnabled sc-ui-select-available-<?php echo NM_encode_input($d_sum['op']); ?>"><?php echo NM_encode_input($d_sum['abbrev']); ?></span><?php
                }
?>
</li>
<?php
...
?>
 ...
 <div  class="sc_ui_sorting-list-wrapper">
         ...
         ?></h4>
         <ul class="sc_ui_sorting-list sc_ui_sorting-list-right sc_ui_sort_summ sc_ui_sort_summ_selected sc_ui_sortable sc_ui_ulist sc_ui_ulist_total scAppDivSelectFields" id="sc_id_summ_selected_<?php echo $nome_quebra; ?>">
<?php
          if (!isset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_display'])) {
              $arr_disp = array();
          }
          else {
                 $arr_disp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['res']['summarizing_fields_display'] : $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_display'];
          }
          if (!isset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_order'])) {
              $arr_ord = array();
          }
          else {
              $arr_ord  = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['res']['summarizing_fields_order']   : $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['summarizing_fields_order'];
          }
...
?>
          <li class="sc_ui_sorting-list-item sc_ui_litem sc_ui_litem_total scAppDivSelectFieldsEnabled" id="selected_sc_id_item_summ_<?php echo $nome_quebra; ?>_<?php echo $iKey; ?>" data-id="selected_sc_id_item_summ_<?php echo $nome_quebra; ?>_<?php echo $iKey; ?>"><?php echo NM_encode_input($sLabel); ?><select class="sc-ui-select-<?php echo $sId; ?>"<?php echo $sSelDisplay; ?> onChange=""><?php
                    foreach ($d_field['options'] as $d_option)
                    {
...
<script>
    var sc_ui_sortable_obj_tot;
    var sc_ui_sortable_obj_tot_r;
          <?php
          ...
          ?>
        sc_ui_sortable_obj_tot = $('#id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list-left').sortable({
            multiGrab: true,
            multiDrag: true,
            sort: false,
            avoidImplicitDeselect: true,
        ...
        sc_ui_sortable_obj_tot_r = $('#id_totalization_fields_<?php echo $nome_quebra; ?> .sc_ui_sorting-list-right').sortable({
            multiGrab: true,
            multiDrag: true,
            avoidImplicitDeselect: true,
            filter: '.scAppDivSelectFieldsDisabled',
...
<script type="text/javascript">
   ...
   if ($this->restore) {
       $oJson = new Services_JSON();
        ob_end_clean();
        if ($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['all']['SC_Ind_Groupby'] == "sc_free_group_by") {
           $this->Arr_result['run_js'][] = "scShowFree()";
        } else {
           $this->Arr_result['set_var'][] = array('var' => 'actual_static_gb', 'value' => $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb']['all']['SC_Ind_Groupby']);
...
<?php
   $disp_rest = "none";
   foreach ($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['dados_orig_gb'] as $tp => $fields) {
       foreach ($fields as $name => $data) {
           if (isset($_SESSION['sc_session'][$sc_init]['autor_livros_assuntos'][$name])) {
               if ($tp == "all" && ($name != "SC_Gb_Free_cmp" || $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos']['SC_Ind_Groupby'] == "sc_free_group_by")) {
                   if ($data != $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos'][$name]) {
                       $disp_rest = "";
                       break;
                   }
               }
               elseif ($tp == "res" && $bSummaryPage && $data != $_SESSION['sc_session'][$sc_init]['autor_livros_assuntos'][$name]) {
                   $disp_rest = "";
                   break;
               }
           }
