...
try {
    ...
    $sql = "SELECT * FROM Livro WHERE Excluido = :excluido ORDER BY Titulo LIMIT :limit OFFSET :offset";
    ...
    $totalSql = "SELECT COUNT(*) as total FROM Livro WHERE Excluido = :excluido";
