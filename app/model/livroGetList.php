...
try {
    ...
    $sql = "SELECT * FROM ".MIGRATION."Livro WHERE Excluido = :excluido ORDER BY Titulo LIMIT :limit OFFSET :offset";
    ...
    $totalSql = "SELECT COUNT(*) as total FROM ".MIGRATION."Livro WHERE Excluido = :excluido";
